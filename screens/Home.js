    ...
    return (
        ...
        <View>
            ...
            >
                ...
                <CityInfo weatheInfo={weatheInfo} darkMode={darkMode} currentTime={currentTime}></CityInfo>
                <WeatherInfo weatheInfo={weatheInfo} darkMode={darkMode}></WeatherInfo>
                <WindInfo weatheInfo={weatheInfo} darkMode={darkMode}></WindInfo>
                <SunRiseAndSet weatheInfo={weatheInfo} darkMode={darkMode} sunrise={sunrise} sunset={sunset} ></SunRiseAndSet>
